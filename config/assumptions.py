...
MODEL_ASSUMPTIONS = [
    ...
    {"id": "A005", "category": "Financial", "assumption": "Convenience store revenue per sqft benchmarked against organized retail averages in fuel station format", "value": "₹1,200/sqft/year", "source": "Organized Retail Industry Benchmark", "sensitivity": "Medium"},
